                            ...
                            <div class="table-responsive">
                                <table id="sortTable1" class="table table-striped table-hover dataTable js-exportable">
                                    ...
                                    @foreach ($sejarah_t as $item)
                                        ...
                                        <tr>
                                            @if ($item['status']=='1')
                                                <td><a href="{{route('ppk.papar.rekod',$item['id'])}}" target="_blank">{{$tuntutan->no_rujukan_tuntutan}}</a></td>
                                            ...
                                            @elseif ($item['status']=='6')
                                                <td><a href="{{route('ppk.papar.saringan.tuntutan',$item['id'])}}" target="_blank">{{$tuntutan->no_rujukan_tuntutan}}</a></td>
