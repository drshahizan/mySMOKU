                                                        ...
                                                        <tr>
                                                            ...
                                                            @elseif ($item['status']=='5')
                                                                <td class="text-center">
                                                                    <!-- Button -->
                                                                    <button class="status-pill status-dikembalikan status-pill-button" data-bs-toggle="modal" data-bs-target="#saringanModal{{ $item['id'] }}">{{ ucwords(strtolower($status)) }}</button>
                                                            ...
                                                            @elseif ($item['status']=='10')
                                                                <td class="text-center"><span class="status-pill status-berhenti">{{ucwords(strtolower($status))}}</span></td>
                                                            @endif
