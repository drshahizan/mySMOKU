...
<body>
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark" style="color:darkblue">Senarai Surat Tawaran</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
    </div>  
            ...
            <div class="block-header">
                ...
                <div class="row clearfix">
                    ...
                    <div class="card">
                        <!--begin::Header-->
                        <div class="header">
                            <h2>Senarai Surat Tawaran<br><small>Sila klik pada ikon Muat Turun di kolum "Tindakan" untuk muat turun surat tawaran bagi pelajar tersebut.</small></h2>
                        </div>
                        <!--end::Header-->
                        <!--begin::Card title-->
     ...
     $(document).ready(function() {
          ...
          function initializeDataTable1() {
              $('#sortTable1').DataTable({
                  ...
                  ajax: {
                      url: '{{ route("penyelaras.ppk.kemaskini.getSenaraiLayak") }}', // URL to fetch data from
