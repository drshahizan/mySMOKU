...
<body>
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark" style="color:darkblue">Senarai Kursus</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
    </div>  
            ...
            <div class="block-header">
                ...
                <div class="row clearfix">
                    ...
                    <div class="card">
                        <!--begin::Header-->
                        <div class="header">
                            <h2>Senarai Kursus<br><small>Sila semak maklumat kursus di <a href="https://www.mqa.gov.my/mqr/" target="_blank">pautan MQA</a></small></h2>
                        </div>
                        <!--end::Header-->
                        <!--begin::Card title-->
     ...
     $(document).ready(function() {
          ...
          function initializeDataTable1() {
              $('#sortTable1').DataTable({
                  ...
                  ajax: {
                      url: '{{ route("kemaskini.getSenaraiKursus") }}', // URL to fetch data from
