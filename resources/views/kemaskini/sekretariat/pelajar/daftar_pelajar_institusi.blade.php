	...
	<!--end::Aside-->
		...
		<div class="card d-flex flex-row-fluid flex-center">
			<!--begin::Form-->
				...
				<form id="kt_create_account_form" action="{{ route('kemaskini.sekretariat.simpan.daftar', ['id' => $smoku->smoku_id ]) }}" method="post" class="card-body py-20 w-100 mw-xl-700px px-9" enctype="multipart/form-data">
				...
				@csrf
					...
					<div class="w-100">
									...
									<div class="col-12">
										...
										<select id="negeri_lahir" name="negeri_lahir" class="form-select form-select-lg form-select-solid basic-search" data-placeholder="Pilih" data-control="select2" data-hide-search="true" >
											...
											@foreach ($negeri as $negerilahir)
												<option value="{{ $negerilahir->id }}" {{ ($butiranPelajar->negeri_lahir ?? null) == $negerilahir->id ? 'selected' : '' }}>
													{{ $negerilahir->negeri }}
												</option>
											@endforeach
										</select>
						...
						<div class="fv-row mb-10">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<textarea id="alamat_tetap" name="alamat_tetap" class="form-control form-control-lg form-control-solid" rows="2" style="text-transform: uppercase;"  style="text-transform: uppercase;">{{$trimmedAddress}}</textarea>
							<!--end::Input-->
						</div>
						<div class="row mb-10">
						...
						<div class="row mb-10">
							<div class="col-md-4 fv-row">
								...
								<div class="col-12">
									...
									<select id="status_pekerjaan" name="status_pekerjaan" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih" >
										<option></option>
										<option value="TIDAK BEKERJA" {{($smoku->status_pekerjaan?? null) == "TIDAK BEKERJA" ? 'selected' : ''}}>TIDAK BEKERJA</option>
										<option value="BEKERJA" {{($smoku->status_pekerjaan?? null) == "BEKERJA" ? 'selected' : ''}}>BEKERJA</option>
									</select>
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							...
							<div class="col-md-4 fv-row" id="div_pekerjaan">
								...
								<div class="col-12">
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" id="pekerjaan" name="pekerjaan" style="text-transform: uppercase;" placeholder="" value="{{strtoupper(($smoku->pekerjaan?? null))}}" />
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							</div>
							<div class="col-md-4 fv-row" id="div_pendapatan">
								...
								<div class="col-12">
									<!--begin::Input-->
									<input type="number" class="form-control form-control-solid" id="pendapatan" name="pendapatan" placeholder="" value="{{($smoku->pendapatan?? null)}}" />
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							</div>
						...
						<div class="row mb-10">
							...
							<div class="col-md-6 fv-row">
								...
								<div class="col-12">
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" maxlength="14" id="no_akaun_bank" name="no_akaun_bank" placeholder="" value="{{ ($butiranPelajar->no_akaun_bank?? null) }}" />
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							</div>
				...
				@csrf	
					...
					<div class="w-100">
						...
						<div class="mb-10 fv-row">
							...
							<!--end::Label-->
							<!--begin::Input-->
							<input type="text" class="form-control form-control-lg form-control-solid" id="nama_waris" name="nama_waris" style="text-transform: uppercase;" placeholder="" value="{{strtoupper(($smoku->nama_waris?? null))}}" />
							<!--end::Input-->
						</div>
						<div class="row mb-10">
							<!--begin::Col-->
						...
						<div class="row mb-10">
							...
							<div class="col-md-6 fv-row">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input type="text" class="form-control form-control-solid" id="tel_bimbit_waris" name="tel_bimbit_waris" placeholder="" value="{{str_replace('-', '', ($smoku->tel_bimbit_waris?? null))}}"  />
								<!--end::Input-->
							</div>
						</div>
						<!--end::Input group-->
						<div class="row mb-10" id="div_waris_lain">
							<div class="col-md-6 fv-row">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input type="text" class="form-control form-control-lg form-control-solid" id="hubungan_lain_waris" name="hubungan_lain_waris" style="text-transform: uppercase;" placeholder="" value="" />
								<!--end::Input-->													
							</div>
						</div>
						<!--begin::Input group-->
						...
						<div class="row mb-10">
							<div class="col-md-6 fv-row">
								...
								<div class="col-12">
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" id="pekerjaan_waris" style="text-transform: uppercase;" name="pekerjaan_waris" placeholder="" value="{{($smoku->pekerjaan_waris?? null)}}" />
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							</div>
							<div class="col-md-6 fv-row">
								...
								<div class="col-12">
									<!--begin::Input-->
									<input type="number" class="form-control form-control-solid" id="pendapatan_waris" name="pendapatan_waris" placeholder="RM" value="{{($smoku->pendapatan_waris?? null)}}" />
									<!--end::Input-->
								</div>
								<!--end::Input wrapper-->
							</div>
					...
					<div class="w-100">
						...
						<div class="d-flex flex-column mb-7 fv-row">
							...
							<select id="id_institusi" name="id_institusi" class="form-select form-select-solid basic-search" data-control="select2" data-hide-search="true" data-placeholder="Pilih">
								...
								@foreach ($institusi as $institusi)
									<option value="{{$institusi->id_institusi}}" {{($akademik->id_institusi?? null) == $institusi->id_institusi ? 'selected' : ''}}>{{ strtoupper($institusi->nama_institusi)}}</option>
								@endforeach
							</select>							 
						</div>
						<!--begin::Input group-->
						<div class="row mb-10">
							<div class="col-md-6 fv-row">
								...
								<!--end::Label-->
								<input type="text" class="form-control form-control-solid" placeholder="" id="no_pendaftaran_pelajar" name="no_pendaftaran_pelajar" value="{{($akademik->no_pendaftaran_pelajar?? null)}}" />
							</div>
							<!--begin::Col-->
							<div class="col-md-6 fv-row">
								<!--begin::Label-->
						...
						<div class="row mb-10">
							<div class="col-md-6 fv-row">
								...
								<!--end::Label-->
									<!--begin::Input wrapper-->
									<select id="tempoh_pengajian" name="tempoh_pengajian" onchange=dateCheck() class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih" >
										<option></option>
										@for($i = 1; $i <= 4; $i += 0.5)
											@if(($akademik->tempoh_pengajian?? null) == ($i == (int)$i ? (int)$i : number_format($i, 1)))
						...
						<div class="row mb-10">
							<div class="col-md-6 fv-row" id="div_nama_penaja">
								...
								<!--end::Label-->
								<select id="nama_penaja" name="nama_penaja" class="form-select form-select-solid" data-placeholder="Pilih" data-control="select2" data-hide-search="true" {{ in_array(($butiranPelajar->status?? null), [2, 3, 4, 6, 7, 8, 9]) ? 'disabled' : '' }}>
									<option value="">Pilih</option>
				...
				@csrf
					...
					<div class="w-100">
						...
						<div class="row mb-10">
							<div class="col-md-4 fv-row">
								<!--begin::Label-->
								<label class=" fs-6 fw-semibold form-label mb-2">Program</label>
								<!--end::Label-->
								<!--begin::Input wrapper-->
								<div class="col-12">
									<!--begin::Input-->
									<select id="program" name="program" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Pilih" data-hide-search="true" >
						...
						<div class="d-flex flex-column mb-7 fv-row">
							...
							<div class="row mb-10">
								...
								<br>
								<div class="col-6" >
									<input class="form-check-input" type="checkbox" value="1" id="wang_saku" name="wang_saku"/>
									<label class="fs-6 fw-semibold form-label">
										Elaun Wang Saku
									</label>
								</div>
...
<!--begin::Javascript-->
		...
		<script src="/assets/js/custom/utilities/modals/add-student.js"></script>
							...
							if (response['data']) {
								...
								response['data'].forEach(function(item) {
									...
									var option = `<option value="${item.nama_kursus}" ${isSelected ? "selected" : ""}>
										${item.no_rujukan} - ${uppercaseValue} - ${item.kod_nec} (${item.bidang.toUpperCase()}) - ${item.no_rujukan}
									</option>`;
