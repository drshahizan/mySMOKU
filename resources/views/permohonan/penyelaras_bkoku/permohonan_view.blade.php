					...
					<div class="w-100">
						...
						<div class="row mb-10">
							...
							<div class="col-md-5 fv-row">
								...
								<div class="row fv-row">
									<!--begin::Input wrapper-->
									<input type="hidden" class="form-control form-control-solid" placeholder="" id="peringkat" name="peringkat" value="{{$butiranPelajar->peringkat_pengajian}}" />
									<select id="peringkat_pengajian" name="peringkat_pengajian" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih" {{ in_array($butiranPelajar->status, [2, 3, 4, 6, 7, 8, 9]) ? 'readonly' : '' }}>
										<option></option>
									</select>
									<!--end::Input wrapper-->
								</div>
						...
						<div class="d-flex flex-column mb-7 fv-row">
							...
							<!--end::Label-->
							<input type="hidden" class="form-control form-control-solid" placeholder="" id="nama_kursus_asal" name="nama_kursus_asal" value="{{$butiranPelajar->nama_kursus}}" />
						...
						<div class="row mb-10">
							...
							<div class="col-md-6 fv-row">
								...
								<!--end::Label-->
								<!--begin::Input wrapper-->
								<select name="mod" id="mod" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih" {{ in_array($butiranPelajar->status, [2, 3, 4, 6, 7, 8, 9]) ? 'disabled' : '' }}>
									<option></option>
									@foreach ($mod as $mod)
