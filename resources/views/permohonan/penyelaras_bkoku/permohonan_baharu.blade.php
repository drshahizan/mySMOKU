					...
					<div class="w-100">
						...
						<table class="table table-row-dashed fs-6 gy-5">
							...
							<tbody class="fw-semibold text-gray-600" >
								...
								@if($institusi->jenis_institusi != 'UA')
								<tr>
									<td class="text-gray-800">Salinan Penyata Bank&nbsp;<a href="/assets/contoh/bank.pdf" target="_blank" data-bs-toggle="tooltip" title="Papar Contoh"><i class="fa-solid fa-circle-info"></i></a></td>
								...
								<tr>
									<td class="text-gray-800">Salinan Resit/Invois&nbsp;<a href="/assets/contoh/resit.pdf" target="_blank" data-bs-toggle="tooltip" title="Papar Contoh"><i class="fa-solid fa-circle-info"></i></a></td>
