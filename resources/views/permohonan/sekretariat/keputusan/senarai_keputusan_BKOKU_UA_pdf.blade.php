...
<html>
    <head>
        ...
        <title>Senarai Permohonan BKOKU UA Layak</title>
        <style>
            *{
    ...
    <body>
        ...
        <div style="margin: 15px; display: block;">
            <div class="tittle" style="text-align: center; font-size: 14px;">
                <b>SENARAI KEPUTUSAN PERMOHONAN BKOKU UNIVERSITI AWAM</b>
            </div>
            <br>
            {{-- Table --}}
            @php
            ...
            <table class="table table-striped" style="@if($chunkIndex > 0) page-break-before: always; @endif">
                <thead>
