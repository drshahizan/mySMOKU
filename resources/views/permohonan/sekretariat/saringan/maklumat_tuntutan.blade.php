...
{{--                                                        <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Baki (RM)</th>--}}
                                                ...
                                                <tbody>
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="yuran_disokong" id="yuran_disokong" value="{{number_format($permohonan->amaun_yuran)}}"></td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_disokong">{{number_format($permohonan->baki_disokong)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="yuran_dibayar" id="yuran_dibayar" value="{{number_format($permohonan->amaun_yuran)}}"></td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_dibayar">{{number_format($baki_y)}}</td>--}}
                                                    </tr>
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_disokong" id="w_saku_disokong" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="w_baki_disokong">{{number_format(0)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_dibayar" id="w_saku_dibayar" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="w_baki_dibayar">{{number_format(0)}}</td>--}}
                                            ...
                                            <table class="maklumat2">
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><input type="number" id="jumlah_disokong" name="jumlah_disokong" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>
                                                </tr>
{{--                                                <tr>--}}
{{--                                                    <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                    <td>:</td>--}}
{{--                                                    <td><input type="number" id="jumlah_dibayar" name="jumlah_dibayar" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>--}}
{{--                                                </tr>--}}
                                                <tr>
...
{{--                                                    <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Dibayar (RM)</th>--}}
                                                ...
                                                <tr class="font-weight-bolder font-size-lg">
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest">Wang Saku</td>
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->amaun_wang_saku)}}</td>
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_disokong" id="w_saku_disokong_2" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>
{{--                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_dibayar" id="w_saku_dibayar_2" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>--}}
                                                </tr>
                                                </tbody>
                                            </table>
                                            <table class="maklumat2">
                                                <tr>
                                                    <td>Jumlah tuntutan yang disokong (RM)</td>
                                                    <td>:</td>
                                                    <td><input type="number" id="jumlah_disokong_2" name="jumlah_disokong" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>
                                                </tr>
{{--                                                <tr>--}}
{{--                                                    <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                    <td>:</td>--}}
{{--                                                    <td><input type="number" id="jumlah_dibayar_2" name="jumlah_dibayar" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>--}}
{{--                                                </tr>--}}
                                                <tr>
                                                    <td class="vertical-top">Catatan</td>
                                                    <td class="vertical-top">:</td>
                                        ...
                                        <script>
                                            ...
                                            function SokongW(){
                                                ...
                                                document.getElementById('jumlah_disokong_2').value= w_saku;
                                            }
                                            // function BayarW(){
...
{{--                                                        <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Baki (RM)</th>--}}
                                                    ...
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->amaun_yuran)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($baki_y)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="yuran_disokong" id="yuran_disokong_3" value="{{number_format($permohonan->amaun_yuran)}}"></td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_disokong_3">{{number_format($permohonan->baki_disokong)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="yuran_dibayar" id="yuran_dibayar_3" value="{{number_format($permohonan->amaun_yuran)}}"></td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_dibayar_3">{{number_format($baki_y)}}</td>--}}
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <table class="maklumat2">
                                                    <tr>
                                                        <td>Jumlah tuntutan yang disokong (RM)</td>
                                                        <td>:</td>
                                                        <td><input type="number" id="jumlah_disokong_3" name="jumlah_disokong" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>
                                                    </tr>
{{--                                                    <tr>--}}
{{--                                                        <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                        <td>:</td>--}}
{{--                                                        <td><input type="number" id="jumlah_dibayar_3" name="jumlah_dibayar" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>--}}
{{--                                                    </tr>--}}
                                                    <tr>
                                                        <td class="vertical-top">Catatan</td>
                                                        <td class="vertical-top">:</td>
                                            ...
                                            <script>
                                                ...
                                                function SokongY(){
                                                    ...
                                                    document.getElementById('jumlah_disokong_3').value= jumlah;
...
{{--                                                    <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Dibayar (RM)</th>--}}
                                                ...
                                                <tr class="font-weight-bolder font-size-lg">
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest">Wang Saku</td>
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->amaun_wang_saku)}}</td>
                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_disokong" id="w_saku_disokong_ppk" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>
{{--                                                    <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right"><input type="number" name="w_saku_dibayar" id="w_saku_dibayar_ppk" value="{{number_format($permohonan->amaun_wang_saku)}}"></td>--}}
                                                </tr>
                                                </tbody>
                                            </table>
                                            <table class="maklumat2">
                                                <tr>
                                                    <td>Jumlah tuntutan yang disokong (RM)</td>
                                                    <td>:</td>
                                                    <td><input type="number" id="jumlah_disokong_ppk" name="jumlah_disokong" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>
                                                </tr>
{{--                                                <tr>--}}
{{--                                                    <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                    <td>:</td>--}}
{{--                                                    <td><input type="number" id="jumlah_dibayar_ppk" name="jumlah_dibayar" value="{{number_format($jumlah)}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>--}}
{{--                                                </tr>--}}
                                                <tr>
                                                    <td class="vertical-top">Catatan</td>
                                                    <td class="vertical-top">:</td>
                                        ...
                                        <script>
                                            ...
                                            function SokongPPK(){
                                                ...
                                                w_saku = parseFloat(w_saku);
                                                document.getElementById('jumlah_disokong_ppk').value= w_saku;
                                            }
                                            // function BayarPPK(){
