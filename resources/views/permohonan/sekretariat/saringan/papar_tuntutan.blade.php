...
{{--                                                        <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Baki (RM)</th>--}}
                                                    ...
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->yuran_disokong)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($j_tuntutan->jumlah - $permohonan->yuran_disokong - $permohonan->wang_saku_disokong)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->yuran_dibayar)}}</td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($j_tuntutan->jumlah - $permohonan->yuran_dibayar - $permohonan->wang_saku_dibayar)}}</td>--}}
                                                    </tr>
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->wang_saku_disokong)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format(0)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->wang_saku_dibayar)}}</td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format(0)}}</td>--}}
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <table class="maklumat2">
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>{{number_format($permohonan->yuran_disokong + $permohonan->wang_saku_disokong)}}</td>
                                                    </tr>
{{--                                                    <tr>--}}
{{--                                                        <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                        <td>:</td>--}}
{{--                                                        <td>{{number_format($permohonan->yuran_dibayar + $permohonan->wang_saku_dibayar)}}</td>--}}
{{--                                                    </tr>--}}
                                                    <tr>
...
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->wang_saku_dibayar)}}</td>--}}
                                                ...
                                                <table class="maklumat2">
                                                    <tr>
                                                        <td>Jumlah tuntutan yang disokong (RM)</td>
                                                        <td>:</td>
                                                        <td>{{number_format($permohonan->wang_saku_disokong)}}</td>
                                                    </tr>
{{--                                                    <tr>--}}
{{--                                                        <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                        <td>:</td>--}}
{{--                                                        <td>{{number_format($permohonan->wang_saku_dibayar)}}</td>--}}
{{--                                                    </tr>--}}
                                                    <tr>
                                                        <td class="vertical-top">Catatan</td>
                                                        <td class="vertical-top">:</td>
...
{{--                                                        <th class="th-green border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest bold white">Baki (RM)</th>--}}
                                                    ...
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($baki_y)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->yuran_disokong)}}</td>
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($j_tuntutan->jumlah - $permohonan->yuran_disokong)}}</td>
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($permohonan->yuran_dibayar)}}</td>--}}
{{--                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right">{{number_format($j_tuntutan->jumlah - $permohonan->yuran_dibayar)}}</td>--}}
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <table class="maklumat2">
                                                    <tr>
                                                        <td>Jumlah tuntutan yang disokong (RM)</td>
                                                        <td>:</td>
                                                        <td>{{number_format($permohonan->yuran_disokong)}}</td>
                                                    </tr>
{{--                                                    <tr>--}}
{{--                                                        <td>Jumlah tuntutan yang dibayar (RM)</td>--}}
{{--                                                        <td>:</td>--}}
{{--                                                        <td>{{number_format($permohonan->yuran_dibayar)}}</td>--}}
{{--                                                    </tr>--}}
                                                    <tr>
                                                        <td class="vertical-top">Catatan</td>
                                                        <td class="vertical-top">:</td>
