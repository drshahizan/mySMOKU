                    ...
                    <div class="row clearfix">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="bkokuPOLI-tab" data-bs-toggle="tab" data-bs-target="#bkokuPOLI" type="button" role="tab" aria-controls="bkokuPOLI" aria-selected="true">
                                        BKOKU POLI
                                        @if ($countPOLI > 0)
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="bkokuKK-tab" data-bs-toggle="tab" data-bs-target="#bkokuKK" type="button" role="tab" aria-controls="bkokuKK" aria-selected="true">
                                        BKOKU KK
                                        @if ($countKK > 0)
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="bkokuIPTS-tab" data-bs-toggle="tab" data-bs-target="#bkokuIPTS" type="button" role="tab" aria-controls="bkokuIPTS" aria-selected="true">
                                        BKOKU IPTS
                                        @if ($countIPTS > 0)
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="ppk-tab" data-bs-toggle="tab" data-bs-target="#ppk" type="button" role="tab" aria-controls="ppk" aria-selected="false">
                                        PPK
                                        @if ($countPPK > 0)
