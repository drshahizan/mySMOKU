					...
					<div class="w-100">
						...
						<div class="row mb-10">
							...
							<div class="pb-10 pb-lg-15">
								...
								<div class="fw-semibold fs-4" style="color: red">*Pemberian bantuan hanya akan dilaksanakan melalui akaun <strong>Bank Islam SAHAJA.</strong></div>
								<div class="fw-semibold fs-4" style="color: red">*Mohon pastikan akaun yang dikemukakan adalah akaun <strong>Bank Islam</strong> yang aktif.</div>
								<div class="fw-semibold fs-4" style="color: red">*Selain akaun <strong>Bank Islam</strong> tidak akan diproses.</div>
								<!--end::Notice-->
							</div>
							<div class="col-md-6 fv-row">
								<!--begin::Label-->
