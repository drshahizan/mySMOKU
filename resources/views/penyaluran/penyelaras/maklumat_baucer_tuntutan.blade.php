                        ...
                        <div class="body">
                            <div class="col-md-6 col-sm-6">
                                ...
                                @php
                                    ...
                                    $nama_penaja = DB::table('bk_penaja')->where('sumber_id', $akademik->nama_penaja)->value('penaja');
                                ...
                                <table class="maklumat">
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>{{$tuntutan->no_rujukan_permohonan}}</td>
                                        <td class="space">&nbsp;</td>
                                ...
                                <hr>
                                <td>
                                    <form method="POST" action="{{ url('permohonan/sekretariat/pembayaran/saring/'.$tuntutan->id) }}" id="saring">
                                        {{csrf_field()}}
                                        @if($tuntutan->program == "BKOKU" && $tuntutan->yuran == "1" && $tuntutan->wang_saku == "1")
                                            ...
                                            <input type="hidden" name="baki_disokong" id="baki_disokong" value="{{$tuntutan->baki_disokong}}">
                                            <input type="hidden" name="baki_dibayar" id="baki_dibayar" value="{{$tuntutan->baki_dibayar}}">
                                            <br>
                                            <h6>Pengiraan:</h6>
                                            <br>
                                            <div class="table-responsive">
                                                ...
                                                <table class="maklumat2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td><input type="number" step="0.01" id="jumlah_dibayar" name="jumlah_dibayar" value="{{number_format($tuntutan->yuran_dibayar+$tuntutan->wang_saku_dibayar, 2, '.', '')}}" oninvalid="this.setCustomValidity('Sila isi ruang ini')" oninput="setCustomValidity('')" required></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        @elseif($tuntutan->program == "BKOKU" && $tuntutan->wang_saku == NULL)
                                            ...
                                            @endphp
                                            <input type="hidden" name="baki" id="baki" value="{{$baki_y}}">
                                            <input type="hidden" name="baki_disokong" id="baki_disokong_3" value="{{$tuntutan->baki_disokong}}">
                                            <input type="hidden" name="baki_dibayar" id="baki_dibayar_3" value="{{$tuntutan->baki_dibayar}}">
                                            <br>
                                            <h6>Pengiraan:</h6>
                                            <br>
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr class="font-weight-bolder font-size-lg">
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_disokong_3">{{number_format($tuntutan->baki_disokong, 2)}}</td>
                                                        ...
                                                        <td class="border-top-0 pr-0 py-4 font-size-h6 font-weight-boldest text-right" id="y_baki_dibayar_3">{{number_format($tuntutan->baki_dibayar, 2)}}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <table class="maklumat2">
