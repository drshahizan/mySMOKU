<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('register') }}">
        ...
        <div class="fv-row mb-8">
            <!--begin::Name-->
            <input type="text" placeholder="Kad Pengenalan" name="Kad Pengenalan" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Name-->
        </div>
        ...
        <div class="fv-row mb-8">
            <!--begin::Email-->
            <input type="text" placeholder="Emel" name="email" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Email-->
        </div>
