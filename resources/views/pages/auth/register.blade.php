...
@endsection  
    ...
    <form class="form w-100" novalidate="novalidate" action="{{ route('register') }}" method="post">
        ...
        <div class="fv-row mb-8">
            <!--begin::Name-->
            <input style="font-size: 20px" type="text" placeholder="No Kad Pengenalan" name="no_kp" maxlength="12" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="form-control bg-transparent" value=""/>
            <!--end::Name-->
        </div>
