										...
										{{-- <div class="flex-lg-auto min-w-lg-400px"> --}}
											...
											<div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<div class="d-flex flex-stack">
														<div class="d-flex">
															...
															<div class="d-flex flex-column">
																...
																{{-- <div class="fs-6 fw-semibold text-gray-400">#</div> --}}
															</div>
														</div>
													...
													<div class="fs-6 fw-semibold text-gray-400">Elaun wang saku akan bertukar mengikut kadar bayaran tuntutan yuran dalam satu sesi pengajian</div>
													<br>
													<br>
													<div class="d-flex flex-stack flex-grow-1">
														<!--begin::Content-->
