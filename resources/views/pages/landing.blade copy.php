...
.content-left {
    position: absolute;
    left: 0; /* Position the element to the left */
    top: 50%;
    transform: translateY(-50%); /* Adjust the transform to center vertically only */
    text-align: left; /* Align text to the left */
    width: 100%;
    max-width: 350px; /* Set a max width for smaller screens */
			...
			<div class="mb-0" id="home">
				...
				<div class="header-background">
								...
								<div class="d-lg-block" id="kt_header_nav_wrapper">
									<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#laman_utama', lg: '#kt_header_nav_wrapper'}">
										...
										<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
											...
											<!--begin::Menu item-->
											<div class="dropdown">
												<button style="font-size: 1.5rem;" class="dropbtn">MAKLUMAT BKOKU</button>
												<div class="dropdown-content">
													<a style="font-size: 1.5rem;" class="menu-link nav-link py-3 px-4 px-xxl-6" href="#info" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Pengenalan</a>
											...
											<!--begin::Menu item-->
											<div class="dropdown">
												<button style="font-size: 1.5rem;" class="dropbtn">MAKLUMAT PPK</button>
												<div class="dropdown-content">
													<a style="font-size: 1.5rem;" class="menu-link nav-link py-3 px-4 px-xxl-6" href="#syarat_ppk" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Info</a>
												</div>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
					...
					<div class="content-left">
						<div style="position: relative; display: inline-block; width: 100%; margin: auto;">
							<!-- Image -->
							<img src="assets/media/picture3.png" alt="KPT Malaysia" style="width: 200%; display: block;">
							<!-- Text overlay -->
							<span style="position: absolute; top: 40%; left: 110%; transform: translate(-50%, -50%); color: white; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5); font-size: 3.0rem; text-align: left; font-family: 'Arial Black', sans-serif; line-height: 1.2;">
								Klik di sini untuk permohonan<br>
								<a href="http://bkoku.mohe.gov.my/login" class="btn btn-permohonan" style="font-size: 1rem; color: #f2f2f2; margin-top: 10px; display: inline-block; align-items: center; padding: 8px 16px;">
									PERMOHONAN&nbsp;<img src="assets/media/arrow.png" alt="KPT Malaysia" width="45px" style="margin-left: 8px; display: inline-block;">
								</a>
							</span>
						</div>
					</div>
					...
					<!--div class="content-center">
						<!--img src="assets/media/sispo.png" alt="KPT Malaysia" width="25%" style="padding-bottom:30px">
						<!--h4 class="text-transition" style="font-size: 3.5rem;font-family: 'Brush Script MT', cursive;"><span class="id-color">Selamat Datang ke</span></h4>
					...
					<div class="container">
						...
						<div class="d-flex flex-column container pt-lg-15">
							...
							<div class="mb-13 text-center">
								<h1 class="fs-2hx fw-bold" style="color: white;" id="info" data-kt-scroll-offset="{default: 100, lg: 150}">PENGENALAN</h1>
							</div>
							<!--end::Heading-->
							<!--begin::Syarat-->
										...
										<div class="d-flex h-100 align-items-center">
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-10 px-10">
												...
												<div class="w-100 mb-10">
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5" style="background-color: #96b6cd; padding: 5px; border-radius: 5px;">
														<span class="fw-bold fs-6">SKOP PEMBIAYAAN BANTUAN KEWANGAN</span>
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
				...
				<div class="py-10 landing-dark-bg" style="background-color: rgb(2, 2, 55);">
					...
					<div class="container">
						...
						<div class="d-flex flex-column container pt-lg-15">
							<!--begin::Heading-->
							<div class="mb-13 text-center">
								<h1 class="fs-2hx fw-bold" style="color: white;" id="syarat_ppk" data-kt-scroll-offset="{default: 100, lg: 150}">PROGRAM PENDIDIKAN KHAS (PPK)</h1>
							</div>
							<!--end::Heading-->
							<!--begin::PPK-->
							<div class="text-center">
