...
<html lang="en">
	...
	<head><base href=""/>
		...
		<style>
			...
			.header-background {
				position: relative;
				background-image: linear-gradient(rgba(207, 13, 59, 0), rgba(76, 114, 148, 0.75) 100.57%), url('assets/media/KPT_1042.jpg');
				/* background-image: url('assets/media/KPT_1042.jpg'); */
			...
			<div class="mb-0" id="home">
				...
				<div class="header-background">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-lg-block" id="kt_header_nav_wrapper">
									<div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#laman_utama', lg: '#kt_header_nav_wrapper'}">
										<!--begin::Menu-->
										<div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-800 menu-state-title-primary nav nav-flush fs-5 fw-semibold" id="kt_landing_menu">
											<!--begin::Menu item-->
											<div class="menu-item">
												<!--begin::Menu link-->
											...
											<div class="menu-item">
												<!--begin::Menu link-->
												<a style="font-size: 1.0rem; color:#f2f2f2" href="http://bkoku.mohe.gov.my/login" class=" menu-link nav-link py-3 px-4 px-xxl-6 btn btn-permohonan">Permohonan</a>
												<!--end::Menu link-->
											</div>
											<!--end::Menu item-->
										</div>
					...
					<div class="content-left">
						...
						<h1 class="text-transition" style="font-size: 3.0rem;"><span style="text-transform:uppercase">Sistem Bantuan Kewangan OKU & PPK</span></h1>
					</div>
					<!--end::Center content-->
