                                ...
                                <div class="body">
                                    <table id="sortTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTPPK/5/970204052445</a></td>
                                            ...
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTBKOKU/4/960909105668</a></td>
                                                <td>Ling Kai Jie</td>
                                                <td>BKOKU</td>                                        
                                                <td class="text-center">09/04/2023</td>
                                            </tr>
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTPPK/2/021212050334</a></td>
                                                <td>Santishwaran A/L Paven</td>
                                                <td>PPK</td>                                        
                                                <td class="text-center">05/06/2023</td>
                                            </tr>
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTBKOKU/3/001205034745</a></td>
                                                <td>Choo Mei Ling</td>
                                                <td>BKOKU</td>
                                            ...
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTPPK/5/981004045253</a></td>
                                            ...
                                            <tr>
                                                <td><a href="{{ url('maklumat-tuntutan-wang-saku') }}" title="">KPTBKOKU/4/950623035672</a></td>
