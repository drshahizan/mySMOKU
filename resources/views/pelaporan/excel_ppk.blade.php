...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark" style="color:darkblue">Data Excel PPK</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
</div>  
                                ...
                                <div class="col-md-12" data-kt-subscription-table-filter="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 fv-row" style="margin-left:65px;">
                                            <a id="exportExcelPPK" href="{{ route('senarai.ppk.excel') }}" target="_blank" class="btn btn-secondary btn-round">
     ...
     $(document).ready(function() {
          ...
          function initializeDataTable1() {
              $('#sortTable1').DataTable({
                  ...
                  ajax: {
                      url: '{{ route("laporan.getExcelPPK") }}', // URL to fetch data from
    ...
    <script>
        ...
        function applyFilter() 
        {
            ...
            if (selectedInstitusi) {
                exportExcelPPK.href = "{{ route('senarai.ppk.excel') }}?institusi=" + encodeURIComponent(selectedInstitusi);
            } else {
                exportExcelPPK.href = "{{ route('senarai.ppk.excel') }}";
            }
        }
