    ...
    $(document).ready(function() {
        ...
        function initializeDataTable1() {
            $('#sortTable1').DataTable({
                ...
                ajax: {
                    url: '{{ route("senarai.esp.tuntutan.BKOKUIPTS") }}', // URL to fetch data from
        ...
        function initializeDataTable2() {
            $('#sortTable2').DataTable({
                ...
                ajax: {
                    url: '{{ route("senarai.esp.tuntutan.BKOKUPOLI") }}', // URL to fetch data from
                    dataSrc: '' // Property in the response object containing the data array
                },
                language: {
                    url: "/assets/lang/Malay.json"
        ...
        function initializeDataTable3() {
            $('#sortTable3').DataTable({
                ...
                ajax: {
                    url: '{{ route("senarai.esp.tuntutan.BKOKUKK") }}', // URL to fetch data from
                    dataSrc: '' // Property in the response object containing the data array
                },
                language: {
                    url: "/assets/lang/Malay.json"
        ...
        function initializeDataTable4() {
            $('#sortTable4').DataTable({
                ...
                ajax: {
                    url: '{{ route("senarai.esp.tuntutan.BKOKUUA") }}', // URL to fetch data from
                    dataSrc: '' // Property in the response object containing the data array
                },
                language: {
                    url: "/assets/lang/Malay.json"
        ...
        function initializeDataTable5() {
            $('#sortTable5').DataTable({
                ...
                ajax: {
                    url: '{{ route("senarai.esp.tuntutan.PPK") }}', // URL to fetch data from
                    dataSrc: '' // Property in the response object containing the data array
                },
                language: {
                    url: "/assets/lang/Malay.json"
