                                                    ...
                                                    <!-- <div class="col-sm-7 pe-0 mb-5 mb-sm-0">
                                                        ...
                                                        <div class="d-flex justify-content-between h-100 flex-column pt-xl-5 pb-xl-2 ps-xl-7">
                                                            ...
                                                            <div class="mb-7">
                                                                ...
                                                                <form class="form w-100" action="{{ route('dashboardpenyelarasppk')}}" method="post">
                                                                ...
                                                                <!--begin::Heading-->
                                                                    ...
                                                                    <h1 class="text-dark fw-bolder mb-3">
                                                                        Daftar Pelajar Program Pendidikan Khas
                                                                    </h1>
                                                                    <!--end::Title-->
                                                                    <br>
                                                                    <br>
                                                    ...
                                                    <table id="sortTable" class="table table-striped table-hover dataTable js-exportable">
                                                        ...
                                                        @foreach ($smoku as $smoku)
                                                            ...
                                                            <td class="" colspan="2">
                                                                ...
                                                                <td class="text-center"><a href="{{route('borangPermohonanBaruPPK',$smoku->nokp)}}"><button class="btn bg-primary text-white">Deraf</button></a></td>
