<x-default-layout>
    ...
    <body>
		...
		<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <!--begin::Item-->
			<li class="breadcrumb-item text-dark" style="color:darkblue">BKOKU Politeknik</li>
			<!--end::Item-->
		</ul>
        <!--end::Breadcrumb-->
        </div>
                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="card">
                            ...
                            <div class="body">      
                                <table id="tuntutanTable" class="table table-bordered table-striped">
                                    <thead>
        ...
        <script>
            $(document).ready(function() {
                ...
                function initializeDataTable() {
                    $('#tuntutanTable').DataTable({
                        ordering: true, // Enable manual sorting
                        order: [], // Disable initial sorting
                        ajax: {
                            url: '{{ route("senaraiStatusPOLI.tuntutan", ["status" => $status]) }}', // URL to fetch data from
