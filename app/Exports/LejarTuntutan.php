...
class LejarTuntutan implements FromCollection, WithHeadings, WithColumnWidths, WithEvents, WithMapping
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        $query = Tuntutan::join('smoku as b', 'b.id', '=', 'tuntutan.smoku_id')
            ...
            ->whereIn('tuntutan.sesi_bayaran', $this->sesi);
