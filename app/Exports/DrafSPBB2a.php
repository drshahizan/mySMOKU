...
class DrafSPBB2a implements FromCollection, WithHeadings, WithColumnWidths, WithEvents, WithMapping
{
    /**
    ...
    */
    ...
    private function getInstitusiData()
    {
        ...
        $institusiData = DB::table('bk_info_institusi')->where('id_institusi', $this->id_user->id_institusi)->value('nama_institusi');
