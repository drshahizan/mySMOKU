...
class SenaraiPendekBKOKU implements FromCollection, WithHeadings, WithMapping, WithEvents, ShouldAutoSize
{
    private $programCode;
    private $filters;
    private $bil = 1;
    ...
    public function collection()
    {
        ...
        $query->where('a.program', 'BKOKU')->where('c.jenis_institusi', 'IPTS');
