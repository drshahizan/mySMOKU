...
Route::middleware('guest')->group(function () {
    ...
    Route::post('register', [DaftarUserController::class, 'semak']);
    ...
    Route::get('/getEmail/{nokp}', [PasswordResetLinkController::class, 'getEmail']);           
    ...
    Route::post('reset-password', [NewPasswordController::class, 'updatePassword'])
