...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('pentadbir/lihat/jumlah-tuntutan', [PentadbirController::class, 'jumlahTuntutan'])->name('jumlah.tuntutan');
    Route::post('pentadbir/kemaskini/jumlah-tuntutan', [PentadbirController::class, 'simpanJumlah'])->name('simpan.jumlah');
