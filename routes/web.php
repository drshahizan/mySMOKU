...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['auth', 'check.tahap:1'])->group(function () {
        ...
        Route::get('/getPeringkatPermohonan/{id}', [PermohonanController::class, 'peringkat']);
        Route::get('/kursusPermohonan/{kodperingkat}/{id}', [PermohonanController::class, 'kursus']);
    ...
    Route::middleware(['auth', 'check.tahap:3'])->group(function () {
        ...
        //Kemaskini - Sekretariat - Maklumat Pelajar
        Route::get('kemaskini/sekretariat/pelajar/maklumat_pelajar', [KemaskiniController::class, 'maklumatPelajar'])->name('kemaskini.sekretariat.pelajar.maklumat');
        ...
        //Kemaskini - Sekretariat - Senarai Penyelaras
        Route::get('kemaskini/sekretariat/senarai/penyelaras/institusi', [PenyelarasController::class, 'senaraiPenyelarasInstitusi'])->name('sekretariat.senarai.penyelaras');
        Route::get('kemaskini/sekretariat/senarai/penyelaras/getSenarai', [PenyelarasController::class, 'getSenaraiPenyelaras'])->name('sekretariat.getSenaraiPenyelaras');
        Route::post('kemaskini/sekretariat/senarai/penyelaras/getSenarai', [PenyelarasController::class, 'kemaskiniPenyelaras'])->name('sekretariat.kemaskini.penyelaras');
    ...
    Route::middleware(['auth', 'check.tahap:2'])->group(function () {
        ...
        Route::get('penyelaras/kemaskini/senarai/penyelaras/institusi', [PenyelarasController::class, 'senaraiPenyelarasInstitusi'])->name('senarai.penyelaras');
        Route::get('penyelaras/kemaskini/senarai/penyelaras/getSenarai', [PenyelarasController::class, 'getSenaraiPenyelaras'])->name('penyelaras.getSenaraiPenyelaras');
        Route::post('penyelaras/kemaskini/senarai/penyelaras/getSenarai', [PenyelarasController::class, 'kemaskiniPenyelaras'])->name('penyelaras.kemaskini.penyelaras');
    ...
    Route::middleware(['auth', 'check.tahap:6'])->group(function () {
        ...
        //Kemaskini - Penyelaras PPK
        Route::get('penyelaras/ppk/kemaskini/senarai/pelajar/institusi', [PenyelarasPPKController::class, 'senaraiPelajarInstitusi'])->name('ppk.senarai.pelajar');
        Route::get('penyelaras/ppk/kemaskini/senarai/pelajar/getSenarai', [PenyelarasPPKController::class, 'getSenaraiPelajarPenyelaras'])->name('ppk.penyelaras.getSenaraiPelajar');
        Route::get('penyelaras/ppk/kemaskini/profil/pelajar/{id}', [PenyelarasPPKController::class, 'profilPelajarInstitusi'])->name('ppk.profil.pelajar.institusi');
