...
<div id="body" class="theme-blush">
    ...
    <div class="themesetting">
        ...
        <div>
            ...
            <a href="#" class="btn btn-primary theme-bg gradient gradient btn-block">View Portfolio</a>
        </div>
    </div>
        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light page_menu">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item vivify swoopInTop delay-350 active"><a class="nav-link" href="index3.html">Campaign</a></li>
                    ...
                    <div class="col-12">
                        <div class="card theme-bg gradient gradient text-light">
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="header">
                                ...
                                <ul class="header-dropdown dropdown">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu theme-bg gradient gradient">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="ml-auto">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button type="button" class="btn btn-sm btn-primary theme-bg gradient">M</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover table-custom spacing5 mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="w350">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar theme-bg gradient gradient-g1" style="width: 45%">
                                                </div>
                                                <div class="progress-bar theme-bg gradient gradient-g2" style="width: 20%">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w350">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar theme-bg gradient gradient-g1" style="width: 63%">
                                                </div>
                                                <div class="progress-bar theme-bg gradient gradient-g2" style="width: 24%">
                                                </div>
                                            </div>
                                            <div class="d-flex bd-highlight mt-2">
                                                <div class="flex-fill bd-highlight">
                                    ...
                                    <tr>
                                        ...
                                        <td class="w350">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar theme-bg gradient gradient-g1" style="width: 71%">
                                                </div>
                                                <div class="progress-bar theme-bg gradient gradient-g2" style="width: 8%">
                                                </div>
                                            </div>
                                            <div class="d-flex bd-highlight mt-2">
                                                <div class="flex-fill bd-highlight">
                                    ...
                                    <tr>
                                        ...
                                        <td class="w350">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar theme-bg gradient gradient-g1" style="width: 23%">
                                                </div>
                                                <div class="progress-bar theme-bg gradient gradient-g2" style="width: 41%">
                                                </div>
                                            </div>
                                            <div class="d-flex bd-highlight mt-2">
                                                <div class="flex-fill bd-highlight">
