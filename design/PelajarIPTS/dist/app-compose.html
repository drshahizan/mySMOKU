...
<head>
<title>Mooli | Inbox Compose</title>
<meta charset="utf-8">
...
<link rel="stylesheet" href="assets/vendor/summernote/dist/summernote.min.css"/>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="mail-inbox">
                                ...
                                <div class="mail-left">
                                    <ul class="nav">
                                        <li class="active"><a href="app-inbox.html"><i class="icon-drawer"></i>Inbox<span class="badge badge-default float-right">13</span></a></li>
                                ...
                                <div class="mail-right check-all-parent">
                                    <div class="mail-compose">
                                        ...
                                        <div class="m-t-30">
                                            <button type="button" class="btn btn-primary theme-bg gradient">Send Message</button>
