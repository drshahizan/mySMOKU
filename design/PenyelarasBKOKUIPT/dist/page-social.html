...
<div id="body" class="theme-cyan">
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li  class="active"><a href="page-social.html"><i class="fa fa-share-alt-square"></i> <span>Social</span></a></li>
        ...
        <!-- Main body part  -->
        <div id="main-content" class="social">
            <div class="container-fluid">
                <!-- Page header section  -->
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-xl-4 col-md-4 col-sm-12">
                            ...
                            <span>JustDo Social,</span>
                        </div>            
                        <div class="col-xl-8 col-md-8 col-sm-12 text-md-right">
                                ...
                                <ul class="right_chat w_followers list-unstyled mb-0">
                                    <li class="online">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="message">3.1m followers</span>
                                            </div>
                                    ...
                                    <li class="offline">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="message">10k followers</span>
                                            </div>
                                            <button class="btn btn-default btn-sm">Follow</button>
                                        </a>
                                    </li>
                                    ...
                                    <li class="online">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="message">1.1m followers</span>
                                            </div>
                                            <button class="btn btn-default btn-sm">Follow</button>
                                        </a>
                                    </li>
                                    <li class="offline">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="name">@Folisise Chosielie</span>
                                                <span class="message">101k followers</span>
                                            </div>
                                            <button class="btn btn-default btn-sm">Follow</button>
                                        </a>
                                    </li>
                                    ...
                                    <div class="body">
                                        <div class="d-flex mb-3">
                                            <div class="icon bg-transparent">
                                                <img src="assets/images/user-small.png" class="rounded-circle mr-3 w40" alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="align-right">
                                            ...
                                            <button class="btn btn-primary theme-bg gradient">Post</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="body">
                                        <div class="d-flex mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-0"><a href="#">Alan Green</a> in <a href="#">New project design</a></h6>
                                                <small class="text-muted font-12">Sept 01, 2020</small>
                                            </div>
                                        </div>                            
                                        <div class="content border-top pt-3">
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                            <div class="img-post multi">
                                    ...
                                    <div class="card-footer">
                                        <a href="#" class="mr-3 text-muted font-13"><i class="fa fa-thumbs-o-up"></i> 10K Likes </a>
                                        <a href="#" class="mr-3 text-muted font-13"><i class="fa fa-comments"></i> 92 Comments </a>
                                        <a href="#" class="text-muted font-13"><i class="fa fa-share-alt"></i> Share</a>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="body">
                                        ...
                                        <div class="content border-top pt-3">
                                            <p>It is a long <a href="#">established</a> fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English</p>
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a <strong>page when looking</strong> at its layout.</p>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <a href="#" class="mr-3 text-muted font-13"><i class="fa fa-thumbs-o-up"></i> 10K Likes </a>
                                ...
                                <div class="card">
                                    <div class="body">
                                        <div class="d-flex mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-0"><a href="#">Alan Green</a> at <a href="#">South Lake Tahoe, California</a></h6>
                                                <small class="text-muted font-12">Sept 12, 2020</small>
                                            </div>
                                        </div>                            
                                        <div class="content border-top pt-3">
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                            <div class="img-post multi">
                                                ...
                                                <img class="img-fluid rounded" src="assets/images/image-gallery/8.jpg" alt="img">
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="card-footer">
                                ...
                                <div class="card">
                                    <div class="body">
                                        <div class="d-flex mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-0"><a href="#">Alan Green</a> at <a href="#">South Lake Tahoe, California</a></h6>
                                                <small class="text-muted font-12">Sept 14, 2020</small>
                                            </div>
                                        </div>
                                        <div class="content border-top pt-3">
                                            <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                            ...
                            <div class="tab-pane vivify fadeIn delay-100" id="Activity">
                                <div class="timeline">
                                    <div class="timeline-item green vivify fadeIn">
                                        <img src="assets/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded-circle">
                                    ...
                                    <div class="timeline-item pink vivify fadeIn">
                                        <img src="assets/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded-circle">
                                    ...
                                    <div class="timeline-item orange vivify fadeIn">
                                        <img src="assets/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded-circle">
                                    ...
                                    <table class="table table-hover table-custom spacing5 mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary theme-bg gradient btn-sm">Follow</button>
                                                    <button class="btn btn-dark btn-sm">Message</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Denise Elliott</a>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Rose Coke</a>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Grace Knight</a>
                                                    <p class="mb-0">+ 264-625-2583</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Elizabeth Martin</a>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Denise Alvarado</a>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar7.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Terry Carter</a>
                                            ...
                                            <tr>
                                                <td class="w60">
                                                    <img src="assets/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded-circle w35">
                                                </td>
                                                <td>
                                                    <a href="#" title="">Michelle Schultz</a>
