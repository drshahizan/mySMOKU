            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active"><a href="app-contacts.html"><i class="fa fa-address-book"></i> <span>Contacts</span></a></li>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="card contact_card">
                                                    ...
                                                    <div class="body text-center">
                                                        <div class="circle">
                                                            <img class="rounded-circle" src="assets/images/sm/avatar7.jpg" alt="">
                                                        </div>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="card contact_card">
                                                    ...
                                                    <div class="body text-center">
                                                        <div class="circle">
                                                            <img class="rounded-circle" src="assets/images/sm/avatar8.jpg" alt="">
                                                        </div>
                                                        <h6 class="mt-3 mb-0">David Wallace</h6>
                                                        <span>jason-porter@info.com</span>
                                                        <ul class="mt-3 list-unstyled d-flex justify-content-center">
