                    ...
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="page-timeline.html">Timeline</a></li>
                            ...
                            <div class="body">
                                <div class="timeline">
                                    <div class="timeline-item">
                                        <img class="rounded-circle w30" src="assets/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar">
                                        ...
                                        <div class="msg">
                                            <article class="media mb-0">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <nav class="d-flex text-muted font-13">
                                                        <a href="#" class="icon mr-3"><i class="fa fa-repeat"></i></a>
                                                        <a href="#" class="icon mr-3"><i class="fa fa-twitter"></i> 24</a>
                                                        <a href="#" class="icon mr-3"><i class="fa fa-heart"></i> 43</a>
                                    ...
                                    <div class="timeline-item">
                                        <img class="rounded-circle w30" src="assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar">
                                    ...
                                    <div class="timeline-item">
                                        <img class="rounded-circle w30" src="assets/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar">
                                    ...
                                    <div class="timeline-item">
                                        <img class="rounded-circle w30" src="assets/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar">
