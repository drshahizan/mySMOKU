                    ...
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="ui-dialogs.html">Dialogs</a></li>                                    
                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <span>JustDo SweetAlert Ui,</span>
                        </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                <p>A basic message</p>
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="basic">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="with-title">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="success">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                <p>An HTML message</p>
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="html-message">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="with-custom-icon">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="autoclose-timer">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="confirm">Click Me</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="body">
                                <p>A replacement for the <b>prompt</b> function</p>
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="prompt">Click Me</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="ajax-loader">Click Me</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="body">
                                    <p>... and by passing a parameter, you can execute something else for <b>Cancel</b>.</p>
                                <button class="btn btn-primary theme-bg gradient js-sweetalert" data-type="cancel">Click Me</button>
                            </div>
                        </div>
                    </div>
                </div>
