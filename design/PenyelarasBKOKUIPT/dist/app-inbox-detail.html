...
<head>
<title>Mooli | Inbox Details</title>
<meta charset="utf-8">
                                ...
                                <div class="mail-right check-all-parent">
                                    <div class="mail-detail-full">
                                        <div class="mail-action clearfix">
                                            <div>
                                                <a href="app-inbox.html" class="btn btn-primary theme-bg gradient btn-sm"><i class="fa fa-arrow-left"></i></a>
