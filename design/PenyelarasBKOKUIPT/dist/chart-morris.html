...
<head>
<title>Mooli | Chart Morris</title>
<meta charset="utf-8">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="m_area_chart2" class="m_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="e_area_chart" class="m_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="m_bar_chart" class="m_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="bar_stacked" class="m_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="m_area_chart" class="m_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="m_line_chart" class="m_chart"></div>
                            </div>
                        </div>                
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <div id="m_donut_chart" class="m_chart"></div>
                            </div>
                        </div>               
                    </div>
                </div>            
