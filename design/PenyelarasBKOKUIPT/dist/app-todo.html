            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active"><a href="app-todo.html"><i class="fa fa-th-list"></i> <span>Todo List</span></a></li>
                        ...
                        <div class="card bg-clear">
                            <nav class="navbar navbar-expand-lg navbar-light bg-light page_menu">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    ...
                                    <div class="ml-auto">
                                        <button type="button" class="btn btn-primary theme-bg gradient" data-toggle="modal" data-target="#addtodo">Add Todo</button>
                                    </div>
                                </div>
                            </nav>
                            <div class="body">
