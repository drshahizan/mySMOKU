...
<head>
<title>Mooli | UI Notifications</title>
<meta charset="utf-8">
                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <span>JustDo Notifications Ui,</span>
                        </div>
                ...
                <div class="row clealfix">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <button type="button" class="btn btn-primary theme-bg gradient btn-toastr" data-context="info" data-message="This is general theme info" data-position="bottom-right">General Info</button>
