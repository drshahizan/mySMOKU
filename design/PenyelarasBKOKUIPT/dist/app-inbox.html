            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active"><a href="app-inbox.html"><i class="fa fa-envelope"></i> <span>Email</span> <span class="badge badge-default mr-0">12</span></a></li>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light page_menu mb-1">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item active"><a class="nav-link" href="#">Gmail</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#">Yahoo</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#">Outlook</a></li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown">Add more</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">MailChimp</a>
                                            <a class="dropdown-item" href="#">Hotmail</a>
                                            <a class="dropdown-item" href="#">Yandex</a>
                                        </div>
                                    </li>
                                </ul>
                                <div class="ml-auto">
                        ...
                        <div class="card">
                            <div class="mail-inbox">
                                <div class="mobile-left">
                                    <a href="javascript:void(0);" class="btn btn-primary theme-bg gradient toggle-email-nav"><i class="fa fa-bars"></i></a>
                                </div>
                                <div class="mail-left">
                                    <ul class="nav">
                                        <li class="active"><a href="javascript:void(0);"><i class="icon-drawer"></i>Inbox<span class="badge badge-default float-right">13</span></a></li>
                                ...
                                <div class="mail-right check-all-parent">
                                    ...
                                    <ul class="mail-list list-unstyled">
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html" >Michael Bradley (5)</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Megan, Me</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Nathan Hunter</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Beverly Oliver</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Nathan, Me</a></div>
                                        ...
                                        <li class="unread">
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Peter Collins (7)</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Nathan (3)</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Nathan, Me (2)</a></div>
                                                <p class="dep"><span class="badge-info badge mr-2">Support</span><span class="msg">There are many variations of passages of Lorem Ipsum available, but the majority</span></p>
                                                <span class="time">29 May</span>
                                            </div>
                                        </li>
                                        <li class="unread">
                                            ...
                                            <div class="md-right">
                                                <div class="title"><a href="app-inbox-detail.html">Peter Collins</a></div>
                                                <p class="dep">Regarding our meeting – <span class="msg">There are many variations of passages of Lorem Ipsum available</span></p>
                                                <span class="time ml-auto">20 Jun</span>
                                            </div>
                                        </li>
