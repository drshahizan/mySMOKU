...
<head>
<title>Mooli | Map JVector Map</title>
<meta charset="utf-8">
            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active"><a href="map-jvectormap.html"><i class="fa fa-map"></i> <span>jVector Maps</span></a></li>
...
<script src="../js/pages/maps/jvectormap.js"></script><!-- Custom Js -->
</body>
</html>
