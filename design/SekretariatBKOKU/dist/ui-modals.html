                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <span>JustDo Modals Popups Ui,</span>
                        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target=".bd-example-modal-lg">Large modal</button>
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target=".bd-example-modal-sm">Small modal</button>
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#exampleModal">modal with button</button>
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#exampleModalCenter">Vertically centered</button>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target=".launch-pricing-modal">Launch Pricing modal</button>
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target=".bd-Users-modal-sm">Users Visitors modal</button>
                                <button type="button" class="btn btn-primary theme-bg gradient" data-toggle="modal" data-target=".new-project-modal">Setup New Project</button>
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target=".feed-post-modal">Feed Post modal</button>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target=".Form-Wizard-modal">Form Wizard modal</button>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group c_form_group">
                                                    ...
                                                    <textarea rows="4" class="form-control no-resize" placeholder="type here what you want..."></textarea>
                                                </div>
                                                <div class="align-right">
                                                    ...
                                                    <button class="btn btn-warning" data-dismiss="modal">Post</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
