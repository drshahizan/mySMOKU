                ...
                <div class="row clearfix">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <div class="mb-2">
                                            ...
                                            <button type="button" class="btn btn-primary theme-bg gradient">Primary</button>
                                        </div>                                    
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <div class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <div class="mb-2">
                                            ...
                                            <button type="button" class="btn btn-primary theme-bg gradient btn-round">Primary</button>
                                        </div>                                    
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <div class="mb-2">
                            ...
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        ...
                                        <button type="button" class="btn btn-primary theme-bg gradient disabled">Primary</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <div class="mb-2">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <a class="btn btn-primary theme-bg gradient" href="javascript:void(0);" role="button">Link</a>
                                <button class="btn btn-primary theme-bg gradient" type="submit">Button</button>
                                <input class="btn btn-primary theme-bg gradient" type="button" value="Input">
                                <input class="btn btn-primary theme-bg gradient" type="submit" value="Submit">
                                <input class="btn btn-primary theme-bg gradient" type="reset" value="Reset">
                            </div>
                        </div>
                    </div>                
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <button type="button" class="btn btn-primary theme-bg gradient mb-2"><i class="fa fa-refresh"></i> <span>Primary</span></button>
                                <button type="button" class="btn btn-info mb-2"><i class="fa fa-info-circle"></i> <span>Info</span></button>
                                <button type="button" class="btn btn-primary theme-bg gradient mb-2" disabled="disabled"><i class="fa fa-refresh fa-spin"></i> <span>Refreshing...</span></button>
                                ...
                                <button type="button" class="btn btn-primary theme-bg gradient mb-2" disabled="disabled"><i class="fa fa-spinner fa-spin"></i> <span>Loading...</span></button>
                                <br>
