...
<head>
<title>Mooli | Form Basic Elements</title>
<meta charset="utf-8">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                <li class="active"><a href="forms-basic.html">Basic Elements</a></li>
                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <span>JustDo Basic Form Elements,</span>
                        </div>
