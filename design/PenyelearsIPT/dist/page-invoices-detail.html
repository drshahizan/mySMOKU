                ...
                <div class="block-header">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <span>JustDo Invoices Details,</span>
                        </div>
                        ...
                        <div class="card">
                            <div class="body">
                                <div class="d-flex align-items-center">
                                    <img src="assets/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                    <div class="ml-3">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <button class="btn btn-primary theme-bg gradient"><i class="icon-printer"></i> Print</button>
                                    </div>
                                </div> 
                            </div>
                        </div>                                       
