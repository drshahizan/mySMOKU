                    ...
                    <ul id="main-menu" class="metismenu animation-li-delay">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="forms-wizard.html">Form Wizard</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2>Horizontal Layout with icon</h2>
                                <ul class="header-dropdown dropdown">
                            ...
                            <div class="body">
                                <div id="wizard_horizontal_icon" class="step_icon">
                                    <h2><i class="fa fa-home"></i></h2>
                                    <section>
                                        <p>In euismod augue ullamcorper leo dignissim quis elementum
                                    ...
                                    <h2><i class="fa fa-hand-o-right"></i></h2>
                                    <section>
                                        <p>In euismod augue ullamcorper leo dignissim quis elementum
                                            arcu porta. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum leo
                                            velit, blandit ac tempor nec, ultrices id diam. Donec metus lacus, rhoncus sagittis
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2>Horizontal Layout with step</h2>
                                <ul class="header-dropdown dropdown">
